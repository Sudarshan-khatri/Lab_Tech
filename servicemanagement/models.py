...
class ServiceManagement(models.Model):
    lab_tests = [
        ...
        ("Serum Electrolytes (Na, K, Cl)", "Serum Electrolytes (Na, K, Cl)"),
        ("Serum Bilirubin", "Serum Bilirubin"),
        ("ALT/SGPT", "ALT/SGPT"),
        ("AST/SGOT", "AST/SGOT"),
        ("ALP (Alkaline Phosphatase)", "ALP (Alkaline Phosphatase)"),
        ("Urine Routine Test", "Urine Routine Test"),
        ("Stool Routine Test", "Stool Routine Test"),
        ("Urine Culture & Sensitivity", "Urine Culture & Sensitivity"),
        ("Stool Culture", "Stool Culture"),
        ("Blood Culture", "Blood Culture"),
        ("Sputum AFB Test", "Sputum AFB Test"),
        ...
        ("Typhoid IgM/IgG", "Typhoid IgM/IgG"),
        ("Pregnancy Test (Urine HCG)", "Pregnancy Test (Urine HCG)"),
        ("Peripheral Blood Smear", "Peripheral Blood Smear"),
        ("Pap Smear", "Pap Smear"),
        ("FNAC (Fine Needle Aspiration Cytology)", "FNAC (Fine Needle Aspiration Cytology)"),
        ("Biopsy (Histopathology)", "Biopsy (Histopathology)"),
        ("Vitamin D3", "Vitamin D3"),
        ("Vitamin B12", "Vitamin B12"),
        ("PSA (Prostate Specific Antigen)", "PSA (Prostate Specific Antigen)"),
        ("CA-125 (Ovarian Cancer Marker)", "CA-125 (Ovarian Cancer Marker)"),
    ...
    Lab_name=models.ForeignKey('lab.LabModel',on_delete=models.CASCADE)
    service=models.CharField(max_length=200,choices=lab_tests,blank=True)
